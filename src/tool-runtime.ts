...
export async function guide(
  ...
  return {
    ...
    capability: {
      ...
      inspect:
        "Use lbb_inspect for ontology, schema metadata, the published conformance report, metadata, entities, and this guide. Use lbb_query with SPARQL property paths for exact path queries.",
